...
!(function (t, e) {
  ...
  !(function (t) {
    if (!t.fetch) {
      ...
      (v.prototype.clone = function () {
        ...
        (m.error = function () {
          let t = new m(null, { status: 0, statusText: '' });
          return (t.type = 'error'), t;
        });
      let s = [301, 302, 303, 307, 308];
        ...
        (t.fetch = function (t, r) {
          return new Promise(function (n, o) {
            ...
            (s.onload = function () {
              ...
              let o = 'response' in s ? s.response : s.responseText;
              n(new m(o, r));
            }),
              (s.onerror = function () {
    ...
    0 !== t._state
      ? ((t._handled = !0),
        r._immediateFn(function () {
          let r = 1 === t._state ? e.onFulfilled : e.onRejected;
          if (null !== r) {
            let n;
            try {
              n = r(t._value);
  ...
  function s(t) {
    ...
    for (let e = 0, o = t._deferreds.length; e < o; e++) n(t, t._deferreds[e]);
    t._deferreds = null;
  }
  function a(t, e) {
    let r = !1;
  ...
  (r.prototype.catch = function (t) {
    ...
    (r.all = function (t) {
      return new r(function (e, r) {
        ...
        let n = Array.prototype.slice.call(t);
    ...
    (r.race = function (t) {
      return new r(function (e, r) {
        for (let n = 0, o = t.length; n < o; n++) t[n].then(e, r);
      });
    }),
    (r._immediateFn =
  ...
  function ot(t, e) {
    ...
    for (let r in e) e.hasOwnProperty(r) && (t[r] = ot(t[r], e[r]));
    return t;
  }
  function it(t, e, r) {
    t[e] = r;
  }
  let st = 'FirebaseError',
    ...
    ct = (function () {
      return function (t, e) {
        if (((this.code = t), (this.message = e), at))
          ...
          let r = Error.apply(this, arguments);
          (this.name = st),
  ...
  !(function (t) {
    function e() {
      ...
      (e.chain_ = []),
        ...
        (e.blockSize = 64),
        (e.pad_[0] = 128);
      for (let r = 1; r < e.blockSize; ++r) e.pad_[r] = 0;
      return e.reset(), e;
    }
    (function (t, e) {
      function r() {
...
!(function (e, t) {
  ...
  try {
      ...
      u = (function () {
        return function (e, t) {
          if (((this.code = e), (this.message = t), c))
            ...
            let n = Error.apply(this, arguments);
            (this.name = a),
              Object.defineProperty(this, 'stack', {
                get: function () {
                  return n.stack;
    ...
    (function (e) {
      function t() {
        ...
        (t.chain_ = []),
          ...
          (t.blockSize = 64),
          (t.pad_[0] = 128);
        for (let n = 1; n < t.blockSize; ++n) t.pad_[n] = 0;
        return t.reset(), t;
      }
      r(t, e),
    ...
    function y(e, t) {
      ...
      for (
        let n = new DataView(e), r = new DataView(t), i = 0;
        i < e.byteLength;
        i++
      )
          ...
          return (
            this.dbPromise ||
              (this.dbPromise = new Promise(function (t, n) {
                let r = indexedDB.open(e.dbName, e.dbVersion);
                (r.onsuccess = function () {
                  t(r.result);
                }),
                  (r.onerror = function () {
    ...
    let M = (function (e) {
      ...
      return (
        ...
        (t.prototype.manifestCheck_ = function () {
          ...
          let e = document.querySelector('link[rel="manifest"]');
          return (
        ...
        (t.prototype.waitForRegistrationToActivate_ = function (e) {
          let t = e.installing || e.waiting || e.active;
...
oSpP = !1;
let oSpPOptions = {
  sAppUrl: 'https://pwa-test.mayanbet.cloud',
  sAppUrlShow: 'https://pwa-test.mayanbet.cloud',
  sOrigUrl: 'https://pwa-test.mayanbet.cloud',
  sOrigFFUrl: 'https://pwa-test.mayanbet.cloud',
  sSubscribeUrl: 'https://pwa-test.spulse.net',
  sSubscribeFFUrl: 'https://pwa-test.spulse.net',
  ...
  bAutoSubscribe: true,
  sAppKey: '8c35166aaf57af53cb8853bb45fc4960',
  prompt_settings: '',
  prompt_title: '',
  prompt_text: '',
  prompt_description: '-',
  prompt_settings_whithout_sw:
    '{"title":"","text":"\u0414\u043e\u0437\u0432\u043e\u043b\u044c\u0442\u0435 \u0441\u0430\u0439\u0442\u0443 pwa-test.mayanbet.cloud \u0432\u0456\u0434\u043f\u0440\u0430\u0432\u043b\u044f\u0442\u0438 \u0432\u0430\u043c \u0441\u043f\u043e\u0432\u0456\u0449\u0435\u043d\u043d\u044f \u043d\u0430 \u0440\u043e\u0431\u043e\u0447\u0438\u0439 \u0441\u0442\u0456\u043b.","style":"sp-popover","textcolor":"#222222","backgroundcolor":"#ffffff","buttoncolor":"#31b58e","iconcolor":"","btncolor":"","allowbtntext":"\u0414\u043e\u0437\u0432\u043e\u043b\u0438\u0442\u0438","disallowbtntext":"\u0417\u0430\u0431\u043e\u0440\u043e\u043d\u0438\u0442\u0438","btn_lang":"ua","visit_number":1,"icon":"/files/push/8728884/websites/8c35166aaf57af53cb8853bb45fc4960/icons/2a1f98d1b6c84.png"}',
  currentDB: null,
  timeSend: null,
  newWindow: null,
  parentEvent: null,
  ...
  show_splogo: '1',
  spdomain_website:
    'https://sendpulse.com/ru/webpush-powered-by-sendpulse?sn=bWF5YW4uYmV0&from=8728884',
  styles_prefix: 'sp',
  aPoweredbyLabel: {
  ...
  promptHintText: {
    ru: 'Ð§Ñ‚Ð¾Ð±Ñ‹ Ñ€Ð°Ð·Ñ€ÐµÑˆÐ¸Ñ‚ÑŒ Ð¿Ð¾ÐºÐ°Ð· Ð·Ð°Ð¿Ñ€Ð¾ÑÐ° Ð½Ð° Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÑƒ, Ð½Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð° Ð¸ÐºÐ¾Ð½ÐºÑƒ ÑƒÐ²ÐµÐ´Ð¾Ð¼Ð»ÐµÐ½Ð¸Ð¹',
    en: 'To enable permission prompts, click on the notification icon',
    ua: 'Ð©Ð¾Ð± Ð´Ð¾Ð·Ð²Ð¾Ð»Ð¸Ñ‚Ð¸ Ð²Ñ–Ð´Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð½Ñ Ð·Ð°Ð¿Ð¸Ñ‚Ñƒ Ð½Ð° Ð¿iÐ´Ð¿Ð¸ÑÐºÑƒ, Ð½Ð°Ñ‚Ð¸ÑÐ½Ñ–Ñ‚ÑŒ Ñ–ÐºÐ¾Ð½ÐºÑƒ Ð¿Ð¾Ð²Ñ–Ð´Ð¾Ð¼Ð»ÐµÐ½ÑŒ',
  },
  iPromptDelay: '0',
  visitNumber: '1',
  bMonetization: 'false',
  ...
  (this.start = function () {
          ...
          void 0 === e.target.result &&
            oSpP.getDbValue('SPIDs', 'PromptClosed', function (e) {
              if (void 0 === e.target.result)
                ...
                let t = parseInt(e.target.result.value);
                0 == --t
    ...
    (this.fetchFcmToken = function (e, t, o) {
      return new Promise(function (i, r) {
        let s = oSpPOptions.fcmServer + 'send/' + encodeURIComponent(e),
        ...
        case 'opera':
          navigator.serviceWorker.ready.then(function (e) {
            e.pushManager
              ...
              .then(function (e) {
                let t = oSpP.endpointWorkaround(e),
                  ...
                  s = r
                    ...
                    : '';
                oSpP.checkLocalSubsctoption(t, i, s), p && oSpP.sendToParent(t);
              })
              .catch(function (t) {
                11 == t.code &&
    ...
    (this.sendSubscribeDataToServer = function (e, t, o, i, s) {
      ...
      if (((o.timezoneoffset = u), C)) a = C;
        ...
        let d = localStorage.getItem('source_url');
        a = d || window.location.href;
      }
      let m = oSpPOptions.sSubscriptionPrefix;
      switch (l) {
        case 'safari':
        case 'firefox':
          m = '';
    ...
    (this.removeTransparentDiv = function () {
      if (document.getElementsByClassName(Y + '-resubscribe-div').length > 0) {
        let e = document.getElementsByClassName(Y + '-resubscribe-div')[0];
    ...
    (this.showPopUp = function () {
      ...
      let e = void 0 !== window.screenLeft ? window.screenLeft : screen.left,
    ...
    (this.sendUpdatesToServer = function (e) {
      let t = oSpPOptions.sSubscriptionPrefix;
      switch (l) {
        case 'safari':
        case 'firefox':
          t = '';
        ...
        if (((i.os = t.getOS().name), void 0 !== V && 0 == V && (e = !1), e)) {
          ...
          setTimeout(function () {
            if (null !== document.querySelector('.' + Y + '-webpush-label')) {
              let e = document.querySelector('.' + Y + '-webpush-label');
              e.setAttribute(
                'class',
    ...
    (this.getPushHintDiv = function () {
      let e = oSpP.getMessageLang(oSpP.getBrowserlanguage()),
    ...
    (this.showCustomPrompt = function () {
      ...
      let i = Y + '-popover',
        ...
        s = !0;
      void 0 !== V && 0 == V && (s = !1);
      let n = oSpP.getMessageLang(oSpP.getBrowserlanguage());
      if (
        (b.length <= 0 &&
          D.length > 0 &&
          !J &&
    ...
    (this.getAuthEmailFromUrl = function () {
      ...
      if (t && t[2]) {
        let o = atob(decodeURIComponent(t[2].replace(/\+/g, ' ')));
